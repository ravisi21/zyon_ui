...
const FloatingBottomLeftPanel = ({ header = "Actions" }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`overflow-y-auto opacity-100 ${expanded ? "flex-1 h-auto" : "h-0"}`}
      >
