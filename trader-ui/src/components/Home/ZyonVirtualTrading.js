    ...
    >
      <div className="flex gap-4 w-full">
        <div className="w-[30%] relative overflow-hidden rounded-xl">
          ...
          <img src="/trader/education.png" alt="virtual trading" className="shadow-xl rounded-xl w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
        </div>
