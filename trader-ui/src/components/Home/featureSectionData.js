const featureSectionData = [
  {
    ...
    title: "Paper Trading",
    animation: "https://assets5.lottiefiles.com/packages/lf20_0yfsb3a1.json",
    sections: [
      {
        heading: "Index Options Furures Stocks trade with virtual capital-Paper Trading ",
        paragraphs: [
      ...
      {
        heading: "Options & Futures",
        paragraphs: [
          "Trade index futures and options like NIFTY, BANK NIFTY, and SENSEX using real-time feeds.",
    ...
    faqs: [
     {
        ...
        answer: "Paper trading is simulated trading using virtual money and live market data. It helps you learn trading, test strategies, and gain experience without risking real capital."
      },
      {
        question: "Is Zyon’s paper trading live or delayed?",
        answer: "Zyon offers real-time market data for paper trading. Your trades reflect actual market conditions with live prices, option chain updates, and bid/ask spreads."
      },
      {
      ...
      },
      {
        ...
        answer: "Every user starts with ₹10,00,000 in virtual capital, giving you plenty of space to experiment, learn, and grow."
      },
      {
        question: "Do I need a broker account to use Zyon?",
        answer: "No. Zyon operates independently of any broker. Just sign up and start trading in our real-time paper trading environment."
      },
      {
        question: "Can I lose real money on Zyon?",
        answer: "No. All trades on Zyon are simulated. You trade with virtual money, so there is zero risk to your real funds."
      },
      {
        question: "What makes Zyon different from other demo platforms?",
        answer: "Zyon isn’t just a charting tool — it’s a complete simulated trading ecosystem with:\n• Live data\n• Option analytics\n• Risk rules like prop firms\n• Competitions\n• Career opportunities for top performers"
      },
      {
        question: "Is paper trading useful if I already have experience?",
        answer: "Yes. Advanced traders use Zyon to:\n• Practice new setups\n• Adjust to market volatility\n• Backtest discretionary strategies\n• Build consistency without risking money"
      },
      {
        question: "Can I access option Greeks while paper trading?",
        answer: "Yes. Zyon displays real-time option Greeks like Delta, Theta, Gamma, Vega — helping you learn the mechanics behind options pricing and risk."
      },
      {
        question: "Are there any trading rules I need to follow?",
        answer: "Yes, we simulate real-world trading discipline:\n• ✅ Max 5 trades per day\n• ✅ Daily loss and overall drawdown limits\n• ✅ Overnight holding is allowed\n• ❌ No averaging down on losing trades"
      },
      {
        question: "How many accounts can I create?",
        answer: "You can create up to 5 paper trading accounts per user. This allows you to test multiple strategies or trade styles simultaneously."
      },
      {
        question: "What happens after I perform well in paper trading?",
        answer: "Top performers are shortlisted for our Zyon Funded Trading Desk. If selected, you’ll get real capital to trade and share profits — no upfront payment required."
      },
      {
        question: "Can I download trade reports or journal my trades?",
        answer: "Yes. Every trade you place is logged. You can review your entry/exit, PnL, and behavioral patterns to continuously improve."
      },
      {
        question: "Is there a leaderboard or performance ranking?",
        answer: "Yes! Zyon has a public leaderboard showing rankings based on profit, risk management, and consistency — helping serious traders build credibility."
      },
      {
        question: "Is this available on mobile?",
        answer: "Yes, the Zyon platform is fully responsive and compatible with mobile devices. You can access it via your mobile browser with full functionality — no app download needed."
      },
      {
        question: "What’s the difference between Paper Trading and the Trading Competition?",
        answer: "While both are powered by real-time market data, they serve different purposes and run on different timelines."
      }
    ],
  },
 {
    ...
    //animation:  "/animation/papertrading.json",
    animation:"https://assets2.lottiefiles.com/packages/lf20_OR2Si7V8SJ.json",
    sections: [
      {
  ...
  {
    heading: "Daily proffit and loss statement of your algo , using virtual capital",
    paragraphs: [
  ...
  },
  {
    ...
    answer: "Algo Forward Testing is a simulation process where your algorithm is run using real-time market data, mimicking how it would behave in a live trading environment without risking real capital."
  },
  {
    question: "How is this different from backtesting?",
    answer: "Backtesting uses historical data, which may not account for slippage or execution delay. Forward testing uses live data, providing a more realistic view of your algo’s performance."
  },
  {
    question: "Do I need coding knowledge?",
    answer: "Yes. You need to bring your trading logic in code format, typically using Python or JavaScript-compatible SDKs. We will offer documentation and basic templates."
  },
  {
    question: "Can I place real trades using forward testing?",
    answer: "No. This is a simulation environment only. You can connect with broker APIs if allowed, but execution is virtual."
  },
  {
    question: "Is slippage included?",
    answer: "Slippage is approximated based on live bid-ask spreads. However, no execution latency is injected unless specifically coded by you."
  },
  {
    question: "Can I monitor logs or metrics?",
    answer: "Yes. Your algo's performance, decision logs, and signal frequency can be monitored from the dashboard in near real time."
  },
  {
    question: "Is option data included in algo feed?",
    answer: "Yes. You get access to live option chains, Greeks, and open interest, just like manual traders."
  },
  {
    question: "Can I test multiple strategies?",
    answer: "Yes. You can create and deploy multiple strategies in parallel, each with separate virtual capital and analytics."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. We provide starter strategies, templates, and SDK documentation so that you can begin testing quickly."
  }
    ],
  },
  {
    ...
    animation: "https://assets4.lottiefiles.com/packages/lf20_myejiggj.json",
    sections: [
      {
    ...
    answer: "It’s a 5-day simulated trading event using real market data where traders compete for the top spot based on performance and risk management."
  },
  {
    question: "When does the competition run?",
    answer: "It starts every Monday at 9:15 AM IST and ends on Friday at 3:30 PM IST. You can enter anytime during the week before the deadline."
  },
  {
    question: "What is the entry fee?",
    answer: "You can join by paying ₹500 using UPI or card. This goes towards prize pools, infra costs, and evaluation."
  },
  {
    question: "What are the rules of the competition?",
    answer: "Rules include:\n• Max 5 trades/day\n• No averaging down\n• Daily drawdown and overall loss limits\n• Overnight trades allowed\n• No external broker login needed"
  },
  {
    question: "What’s the prize for winners?",
    answer: "Top trader gets ₹10,000 in Zyon Coins. The top 5 are offered premium access and may get shortlisted for Zyon’s Funded Account challenge."
  },
   {
    question: "What’s Zyon coin and how to use it ?",
    answer: "Zyon coins are credit to get  funded account, you get 10000 Zyon coin and you get funded to trade in our account you real money with upto 80% profit split to trader."
  },
  {
    question: "What instruments can I trade during the competition?",
    answer: "You can trade index options and futures: NIFTY, BANK NIFTY, and SENSEX. Stock options are not allowed for now."
  },
  {
    question: "How is performance ranked?",
    answer: "Leaderboards consider:\n• Net P&L\n• Risk management\n• Consistency and drawdown control"
  },
  {
    question: "Can I see other traders’ performance?",
    answer: "Yes. Leaderboards are public and refresh live with rankings and key stats."
  },
  {
  question: "What is the consistency rule in the competition?",
  answer: "The consistency rule ensures traders don’t rely on one lucky trade. You must maintain performance over multiple days,\nFor example, profits should not be made on just a single trade or day — consistent risk-adjusted returns are favored in leaderboard rankings and funding selection."
},
 {
  question: "Why use consitency rules ?",
  answer: "At Zyon we strive to make you a  funded trader and grow,these rules are not  limitations its your path to success\n These rules are inspired by global HEDGE fund and funded  programs\n This makes you disciplined and  good trader in future  "
},
  {
    question: "What if I break the rules during competition?",
    answer: "Accounts violating trading rules may be disqualified or not considered for funding — even if P&L is positive, but you can still parctice till the competition ends "
  },
  {
    question: "I have made my payment in the midweek can I enter the competition?",
    answer: "No you can subscribe  HE HE who refuses money , but you will be allowed to get into the competition only starting next week"
  },
  {
    question: "Is this good for beginners?",
    answer: "Yes  but serious. You’ll face real-time market speed and structured limits. It’s a great way to test mindset and skills under pressure."
  },
    ],
  },

  {
    ...
    title: "Real Time Dashboard with OI analytics",
    animation: "https://assets4.lottiefiles.com/packages/lf20_myejiggj.json",
    sections: [
      {
        heading: "Real Time Options Analytics",
        paragraphs: [
          "OI shifts, PCR, breadth, and synthetic futures in one dashboard.",
          "No noise, just actionable signals updated in real time.",
        ],
      },
      {
        heading: "Option OI Insights",
        paragraphs: [
          "Track strike-level buildups, unwinding clues, and smart money moves.",
          "Momentum vs volume conflicts, most active options — all visualized.",
        ],
      },
      {
        heading: "Market Breadth & Heatmap",
        paragraphs: [
          "Advance/Decline, sector performance, heatmaps in one screen.",
          "Instantly gauge bullish, bearish, or sideways tone.",
        ],
      },
    ],
    faqs: [
      [
  {
    ...
    answer: "Zyon’s dashboard displays strike-level open interest (OI), changes in OI, volume, implied volatility, and price movement in real-time."
  },
  {
    question: "How often is the data updated?",
    answer: "All option analytics data is updated in real time — you’ll see live OI shifts, PCR changes, and price behavior without delay."
  },
  {
    question: "Can I use this data for intraday trading?",
    answer: "Yes. Traders use this dashboard to spot buildup, unwinding, long/short traps, and momentum shifts in real time."
  },
  {
    question: "Is this data available for all index and stocks ?",
    answer: "No. Currently, the dashboard only supports index options like NIFTY and BANK NIFTY , SENSEX. Stock option analytics are not included."
  },
  {
    question: "Do I need coding knowledge to understand it?",
    answer: "No. The analytics are visualized using heatmaps, trend markers, and simplified signals — no technical background needed."
  },
  {
    question: "Can I export or view historical analytics?",
    answer: "Historical views are coming soon. For now, the dashboard is optimized for live market tracking and fast intraday decisions."
  }
]
    ],
  },
