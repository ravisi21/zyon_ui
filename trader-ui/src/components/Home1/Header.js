          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="md:hidden text-white hover:text-green-400 transition-colors duration-200 p-2"
              >
                <FaBars className="text-xl" />
              </button>

              {/* Desktop Sign In Button */}
              <button className="hidden md:flex bg-green-600 hover:bg-green-700 active:bg-green-500 text-white font-semibold py-2 px-6 rounded-lg transition-colors duration-200 items-center">
