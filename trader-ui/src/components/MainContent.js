  ...
  return (
    <div className="bg-dark-bg rounded-lg p-3 mt-3 flex flex-col flex-1 overflow-y-auto">
      ...
      <div className="flex-1 overflow-y-auto flex flex-col">
        ...
        {activeTab === "Markets" && <MarketAnalyticsWidget ref={marketRef} />}
        {activeTab === "Options" && <OptionsWidget />}
        {activeTab === "Basket" && <BasketsComponent />}
        {/* Other tabs can have placeholder content */}
        {["Positions", "Orders", "Markets", "Options", "Basket"].indexOf(
          activeTab,
        ) === -1 && (
          <div className="text-gray-400 text-center py-20 text-xl">
