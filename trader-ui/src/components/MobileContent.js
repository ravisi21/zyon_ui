  ...
  return (
    <div className="bg-dark-bg rounded-lg p-1 pl-2 pr-3 pt-1 flex flex-col flex-1 overflow-y-auto font-family-roboto relative">
      ...
      <div className="flex justify-between mt-2 border-t border-neutral-700 pt-2">
        <div
          className={`flex-1 flex justify-center cursor-pointer py-2 rounded ${activeTab === "Watchlists" ? "bg-price-green text-neutral-800" : "text-neutral-400"}`}
        ...
        <div
          className={`flex-1 flex justify-center cursor-pointer py-2 rounded ${activeTab === "Home" ? "bg-price-green text-neutral-800" : "text-neutral-400"}`}
        ...
        <div
          className={`flex-1 flex justify-center cursor-pointer py-2 rounded ${activeTab === "Analysis" ? "bg-price-green text-neutral-800" : "text-neutral-400"}`}
        ...
        <div
          className={`flex-1 flex justify-center cursor-pointer py-2 rounded ${activeTab === "OptionAnalysis" ? "bg-price-green text-neutral-800" : "text-neutral-400"}`}
        ...
        <div
          ref={overflowMenuRef}
          className={`flex justify-center cursor-pointer py-2 px-3 rounded relative ${showOverflowMenu ? "bg-price-green text-neutral-800" : "text-neutral-400"}`}
