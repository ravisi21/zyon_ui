...
const OrderFormWidget = ({ onCancel, onSuccess }) => {
  ...
  return (
    <div
      className={`font-family-roboto bg-neutral-800 overflow-hidden md:border border-neutral-700 md:rounded-t-xl md:shadow-2xl`}
    >
      {/* Header: Script Info + Buy/Sell Switch */}
      <div
        className={`flex items-center justify-between mb-4 py-2 px-3 ${orderType === "BUY" ? "bg-order-header-blue" : "bg-order-header-red"}`}
      >
        ...
        <div className="flex items-center gap-2">
          <Switch
            ...
            checkedChildren={
              <span className="font-semibold text-sm text-neutral-100 font-family-roboto">
                BUY
              </span>
            }
            unCheckedChildren={
            ...
            style={{
              backgroundColor: orderType === "BUY" ? "#06f" : "#d22",
              width: 80,
            }}
          />
        </div>
      ...
      <div className="flex flex-col px-3">
        ...
        <div className="flex flex-col md:flex-row w-full pb-3">
          ...
          <div className="flex justify-center md:justify-end gap-4 w-full md:w-auto pt-5 md:pt-0">
            ...
            >
              {submitting && (
                <Spin
                  size="small"
                  style={{
                    color: orderType === "BUY" ? "#fff" : "#fff",
                    marginRight: 8,
                  }}
                  indicator={
                    <span
                      className="ant-spin-dot"
                      style={{ color: orderType === "BUY" ? "#fff" : "#fff" }}
                    >
            ...
            <button
              className="px-8 py-2 rounded bg-neutral-500 text-white font-bold text-base hover:bg-neutral-600"
